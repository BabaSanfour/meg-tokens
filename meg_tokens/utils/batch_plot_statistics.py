"""
Stage 7 statistical plotting and reporting.
...
from meg_tokens.io import derivative_path, ensure_dir, load_array, require_file, save_sidecar, save_table
from meg_tokens.meg.plotting import plot_correlation
from meg_tokens.meg.stats import get_significance_windows
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Plot group-level statistics from derivative arrays.")
    parser.add_argument("--stats_dir", type=str, required=True,
                        help="BIDS derivatives root containing Stage 6 group statistics.")
    parser.add_argument("--out_dir", type=str, required=True,
                        help="BIDS derivatives root for statistical figures and summary tables.")
    ...
    parser.add_argument("--labels", type=str, nargs="+", default=None,
                        help="Specific label names or label indices to plot.")
    parser.add_argument("--top_n", type=int, default=8,
                        help="Number of labels to plot when --labels is omitted.")
    parser.add_argument("--alpha", type=float, default=0.05)
    parser.add_argument("--peak_mode", type=str, default="min", choices=["min", "max", "abs"])
    parser.add_argument("--behavior_dir", type=str, default=None,
                        help="BIDS derivatives root containing Stage 1 behavior TSV files.")
    parser.add_argument("--correlate_behavior", action="store_true",
                        help="Correlate plotted subject peak latencies with mean rawRT.")
    return parser
