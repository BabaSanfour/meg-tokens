"""ROI decoding wrapper around the Stage 8 derivative-aware decoder."""
...
def run_batch_decoding_roi(
    ...
    *,
    ...
    labels = None if roi in (None, "all") else [roi]
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run ROI time-resolved decoding from Stage 6 ERP derivatives.")
    ...
    parser.add_argument("--roi", type=str, default=None,
                        help="ERP label name or index. Use 'all' or omit to decode all labels jointly.")
