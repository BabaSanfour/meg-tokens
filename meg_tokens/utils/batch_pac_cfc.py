"""Stage 12 phase-amplitude coupling over Hilbert feature derivatives."""
...
def pac_derivative_path(
    ...
    *,
    ...
    phase_token = "+".join(band.replace("_", "-") for band in phase_bands)
    amplitude_token = "+".join(band.replace("_", "-") for band in amplitude_bands)
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Compute PAC/CFC from Stage 11 Hilbert feature derivatives.")
    parser.add_argument("--feature_dir", type=str, required=True,
                        help="BIDS derivatives root containing Stage 11 Hilbert feature arrays.")
    parser.add_argument("--out_dir", type=str, required=True,
                        help="BIDS derivatives root for PAC/CFC outputs.")
    ...
    parser.add_argument("--phase_bands", type=str, nargs="+", required=True,
                        help="Low-frequency phase bands, matching Stage 11 band names.")
    parser.add_argument("--amplitude_bands", type=str, nargs="+", required=True,
                        help="High-frequency amplitude bands, matching Stage 11 band names.")
    ...
    parser.add_argument("--method", type=str, default="modulation_index", choices=["modulation_index"])
    parser.add_argument("--n_bins", type=int, default=18)
    parser.add_argument("--time_window", type=float, nargs=2, default=None,
                        help="Optional analysis window in seconds.")
    return parser
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    run_batch_pac_cfc(
        ...
        amplitude_bands=args.amplitude_bands,
